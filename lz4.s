...
/* See original source at : http://community.arm.com/docs/DOC-10570 */  
...
gotLength:          bx                  lr                  /* return */
                   ...
                   .thumb_func
copyData:           subs                r1,r1,r2            /* get distance between source and destination */
copyDataLoop:       ldrb                r3,[r2]             /* read byte from source */
                    strb                r3,[r1,r2]          /* store in destination */
                    adds                r2,r2,#1            /* advance source pointer */
                    subs                r4,r4,#1            /* decrement counter */
                    bne                 copyDataLoop        /* keep going while counter is not zero */
                    adds                r1,r1,r2            /* point r1 to new destination */
                    bx                  lr                  /* return */
